...
public class Lottery_649_Parser 
{
	// Taiwan Lottery URL
	...
	public Lottery_649_Parser() throws Exception
	{
		Document doc = Jsoup.connect(url).get();		
		//Elements links = doc.select("table[class]");
	...
	{
		try {
			Lottery_649_Parser LP = new Lottery_649_Parser();
		} catch (Exception e) {
